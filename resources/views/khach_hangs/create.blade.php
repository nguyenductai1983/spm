        ...
        <div class="card card-custom border-0 shadow-sm overflow-hidden">
            <div class="card-header bg-dark text-white p-4" style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%) !important;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="fw-bold mb-0">Thêm Khách Hàng</h4>
                        <p class="text-muted-light mb-0" style="color: #94a3b8; font-size: 0.9rem;">Nhập thông tin khách hàng xuất khẩu mới vào danh mục</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('khach-hangs.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        @enderror
                        <div class="form-text text-muted">Mã khách hàng viết liền không dấu, là duy nhất trong hệ thống.</div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-5 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-gradient-primary px-4 py-2 shadow-sm">
                            <i class="bi bi-save me-2"></i>Lưu khách hàng
                        </button>
                    </div>
                </form>
            </div>
